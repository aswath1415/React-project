...
function AboutUs() {
    ...
    const paperStyle2={padding:20, height:'60vh', width:'80%', margin:"20px auto" ,backgroundImage: 'url(https://e1.pxfuel.com/desktop-wallpaper/70/98/desktop-wallpaper-event-startups-in-india-creative-business-ideas-in-events-startups-india-event-management.jpg)', backgroundSize: 'cover',  backgroundColor: 'rgba(255, 255, 255, 0.8)',};
        ...
        <Grid container justifyContent="center">
            <Paper style={paperStyle} className="a">
                <div>
                    ...
                    <h4>Surprise Bro, your premier event organizer, specializes in crafting unforgettable moments. With a passion for creativity and meticulous planning, we bring your dreams to life. From birthdays to corporate affairs, our dedicated team ensures seamless events, leaving you and your guests in awe. Expect the extraordinary with Surprise Bro!</h4>
                </div>
            </Paper>
